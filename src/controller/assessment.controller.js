...
const createAlergiaNewUser = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "insert into alergias (id_alergias, alergia) values ($1,$2)",
      [id_alergias, alergia]
    );
...
const createEnfermedadNewUser = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "insert into enfermedades (id_enfermedad, enfermedad) values ($1,$2)",
...
const createMedicamentosNewUser = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "insert into medicamentos (id_medicamentos, medicamento) values ($1,$2)",
...
const createInfoGeneral = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "insert into info_general (id_info, fuma, alcohol, cafe, ejercicio, cirugias, alergias, medicamentos, enfermedades) values ($1,$2,$3,$4,$5,$6,$7,$8,$9)",
      [
        id_info,
        fuma,
        alcohol,
...
const updateTipUsers = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "update tipo_usuario set info_general = $1 where documento_tipo = $2",
      [info_general, documento_tipo]
    );
...
const createMeasures = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "insert into medidas (id_medidas) values ($1)",
      [id_medidas]
    );
...
const createMeasuresBasic = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "update medidas set pecho = $1, brazo_derecho=$2, brazo_izquierdo=$3, antebrazo_derecho=$4, antebrazo_izquierdo=$5,abdomen=$6,gluteo=$7,pierna_derecha=$8,pierna_izquierda=$9,pantorrilla_izquierda=$10,pantorrilla_derecha=$11 where id_medidas=$12",
      [
        pecho,
        brazo_derecho,
        brazo_izquierdo,
...
const getDocument = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "select documento_valoracion from valoracion_basica where id_medidas_valoracion = $1",
...
const cancellAssessmentBasic = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "delete from valoracion_basica where documento_valoracion = $1 and id_medidas_valoracion = $2",
      [documento_valoracion, id_medidas_valoracion]
    );
...
const deleteMeasures = async (req, res) => {
  try {
    ...
    const respuesta = await pool.query(
      "delete from medidas where id_medidas = $1",
      [id_medidas]
    );
...
const createGenerales = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "insert into generales (id_generales,peso,imc,estatura) values ($1,$2,$3,$4)",
      [id_generales, peso, imc, estatura]
    );
...
const createMasa = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "insert into masa_muscular (id_masa) values ($1)",
      [id_masa]
    );
...
const createGrasa = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "insert into grasa_corporal (id_grasa) values ($1)",
      [id_grasa]
    );
...
const updateGenerales = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "update generales set agua_corporal = $1, masa_osea = $2, grasa_visceral = $3, bmr = $4, k_caloria = $5 where id_generales = $6",
      [agua_corporal, masa_osea, grasa_visceral, bmr, k_caloria, id_generales]
    );
...
const updateMasaCorporal = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "update masa_muscular set torso=$1, brazo_derecho=$2, brazo_izquierdo=$3, pierna_derecha=$4, pierna_izquierda=$5, total=$6, valoracion_fisica=$7 where id_masa = $8",
      [
        torso,
        brazo_derecho,
        brazo_izquierdo,
...
const updateGrasaCorporal = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "update grasa_corporal set torso =$1, brazo_derecho=$2, brazo_izquierdo=$3, pierna_derecha=$4, pierna_izquierda=$5, total=$6 where id_grasa = $7",
      [
        torso,
        brazo_derecho,
        brazo_izquierdo,
    ...
    if (response.error) {
      ...
      res
        .status(200)
        .json("Actualizacion de grasa corporal realizada con exito");
    }
  } catch (error) {
    res.status(401).json(error.details);
  }
...
const getDocumentAdvanced = async (req, res) => {
  try {
    const {id_medidas_valoracion} = req.body;
    const response = await pool.query(
      "select documento_valoracion from valoracion_avanzada where id_medidas_valoracion = $1",
      [id_medidas_valoracion]
    );
...
const deleteAssessmentAdvanced = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "delete from valoracion_avanzada where documento_valoracion = $1 and id_medidas_valoracion = $2 and id_generales_valoracion = $3",
      [documento_valoracion, id_medidas_valoracion, id_generales_valoracion]
    );
...
const deleteGenerales = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "delete from generales where id_generales = $1",
      [id_generales]
    );
...
const deleteMasa = async (req, res) => {
  try {
    const {id_masa} = req.body;
    const response = await pool.query(
      "delete from masa_muscular where id_masa = $1",
      [id_masa]
    );
...
const deleteGrasa = async (req, res) => {
  try {
    const {id_grasa} = req.body;
    const response = await pool.query(
      "delete from grasa_corporal where id_grasa = $1",
      [id_grasa]
    );
...
const searchAssessmentBasic = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "select id_medidas_valoracion, fecha from valoracion_basica where documento_valoracion = $1",
      [documento_valoracion]
    );
...
const searchAssessmentAdvanced = async (req, res) => {
  try {
    const {documento_valoracion} = req.body;
    const response = await pool.query(
      "select id_medidas_valoracion, fecha from valoracion_avanzada where documento_valoracion = $1",
      [documento_valoracion]
    );
...
const selectEstatura = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "select max(estatura) from valoracion_avanzada, generales, usuarios where documento_valoracion=documento and id_generales_valoracion=id_generales and documento=$1",
      [documento]
    );
...
const selectGenerales = async (req, res) => {
  try {
    const {id_generales} = req.body;
    const response = await pool.query(
      "select * from generales where id_generales = $1",
      [id_generales]
    );
...
const selectMasa = async (req, res) => {
  try {
    const {id_masa} = req.body;
    const response = await pool.query(
      "select * from masa_muscular where id_masa = $1",
      [id_masa]
    );
...
const selectGrasa = async (req, res) => {
  try {
    const {id_grasa} = req.body;
    const response = await pool.query(
      "select * from grasa_corporal where id_grasa = $1",
      [id_grasa]
    );
...
const selectMeasures = async (req, res) => {
  try {
    const {id_medidas} = req.body;
    const response = await pool.query(
      "select * from medidas where id_medidas = $1",
      [id_medidas]
    );
  ...
  try {
    ...
    const response = await pool.query(
      ...
      WITH valoraciones AS (
        SELECT documento_valoracion, estatura
        FROM valoracion_basica
        WHERE documento_valoracion = $1

        UNION ALL

        SELECT documento_valoracion, estatura
        FROM generales g
        JOIN valoracion_avanzada va ON g.id_generales = va.id_generales_valoracion
        WHERE va.documento_valoracion = $1
      )

      SELECT estatura
      FROM valoraciones
      ORDER BY documento_valoracion DESC, estatura DESC
      LIMIT 1;
      `,
      [documento_valoracion]
    );
...
const createGeneralesOld = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "insert into generales (id_generales,estatura) values ($1,$2)",
      [id_generales, estatura]
    );
...
const selectImc = async (req, res) => {
  try {
    const {documento} = req.body;
    const response = await pool.query(
      "select imc, peso, estatura, fecha from valoracion_basica, usuarios, medidas where documento_valoracion=documento and id_medidas_valoracion=id_medidas and documento = $1",
      [documento]
    );
...
const selecGeneralesAdvanced = async (req, res) => {
  try {
    const {documento} = req.body;
    const response = await pool.query(
      "select documento_valoracion, fecha, peso, masa_osea, agua_corporal, grasa_visceral, bmr,k_caloria, imc, estatura, nombre_tipo_genero from valoracion_avanzada, generales, usuarios, genero where documento_valoracion=documento and id_generales_valoracion=id_generales and genero=id_genero and documento = $1",
      [documento]
    );
...
const selectMasaMuscular = async (req, res) => {
  try {
    const {documento} = req.body;
    const response = await pool.query(
      "SELECT documento_valoracion,torso,brazo_derecho,brazo_izquierdo, pierna_derecha, pierna_izquierda,total,rango,fecha,icono FROM valoracion_avanzada, masa_muscular, usuarios, valoracion_fisica where documento_valoracion=documento and id_masa_valoracion=id_masa and valoracion_fisica=id_valoracion_fisica and documento = $1",
      [documento]
    );
...
const searchTypeAssessmentclient = async (req, res) => {
  try {
    const {documento} = req.body;
    const response = await pool.query(
      "select id_valoracion, nombre_valoracion from tipo_valoracion, tipo_usuario, usuarios where id_valoracion_tipo=id_valoracion and documento_tipo=documento and documento= $1",
      [documento]
    );
...
const CreateSolicitadAssessment = async (req, res) => {
  try {
    ...
    const hora = 1;
    const response = await pool.query(
      "insert into reservacion_usuario ( id_reservacion_usuario, documento_reservacion, fecha, state, hora ) values ($1,$2,current_date,$3,$4)",
      [id_reservacion_usuario, documento_reservacion, state, hora]
    );
...
const cancellQuoteAssessment = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "delete from reservacion_usuario where documento_reservacion = $1 and state = $2",
      [documento_reservacion, state]
    );
...
const selectUserQuotes = async (req, res) => {
  try {
    const response = await pool.query(
      "SELECT id_reservacion, nombre_reservacion,documento, nombres, primer_apellido, segundo_apellido FROM reservacion, reservacion_usuario, usuarios, estado where id_reservacion_usuario=id_reservacion and documento_reservacion=documento and state=id_tipo and id_tipo=1"
    );
...
const selectTimeQuote = async (req, res) => {
  try {
    const {fecha} = req.body;
    const response = await pool.query(
      "select id_hora, horas from reservacion_hora except select id_hora,horas from reservacion, reservacion_usuario, reservacion_hora, estado, usuarios where state=id_tipo and hora=id_hora and documento_reservacion=documento and id_reservacion_usuario=id_reservacion and fecha= $1 and state = 2 order by horas asc",
      [fecha]
    );
...
const assingQuote = async (req, res) => {
  try {
    const {id_reservacion_usuario, documento_reservacion, fecha, hora} =
      req.body;
    const state = 2;
    const response = await pool.query(
      "update reservacion_usuario set id_reservacion_usuario = $1, fecha = $2, state = $3, hora = $4 where documento_reservacion = $5",
      [id_reservacion_usuario, fecha, state, hora, documento_reservacion]
    );
...
const createNotificationQuote = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "insert into noti_usu (id_noti_us, documento_usu, fecha, hora) values ($1,$2,current_date,current_time)",
      [id_noti_us, documento_usu]
    );
...
const updateStateTemp = async (req, res) => {
  try {
    const {documento_reservacion, state} = req.body;
    const response = await pool.query(
      "update reservacion_usuario set state = $1 where documento_reservacion = $2",
      [state, documento_reservacion]
    );
...
const selectAllState = async (req, res) => {
  try {
    const response = await pool.query(
      "select id_tipo, tipo_de_estado from estado where not id_tipo = 6 and not id_tipo = 1 order by id_tipo desc"
    );
...
const updateQuoteAssing = async (req, res) => {
  try {
    const {id_reservacion_usuario, documento_reservacion, fecha, state, hora} =
      req.body;
...
const searchEmailUserAdvanced = async (req, res) => {
  try {
    const {id_medidas_valoracion} = req.body;
    const response = await pool.query(
      "select documento, correo from valoracion_avanzada, usuarios where documento_valoracion = documento and id_medidas_valoracion = $1",
      [id_medidas_valoracion]
    );
...
const searchEmailUserBasic = async (req, res) => {
  try {
    const {id_medidas_valoracion} = req.body;
    const response = await pool.query(
      "select documento, correo from valoracion_basica, usuarios where documento_valoracion = documento and id_medidas_valoracion = $1",
      [id_medidas_valoracion]
    );
