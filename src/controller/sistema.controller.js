...
const updateMision = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "update general_empresa set mision = $1 where id_generales_empresa = $2",
      [mision, id_generales_empresa]
    );
    if (response.error) {
      res.status(401).json(response.error);
    } else {
...
const updateVision = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "update general_empresa set vision = $1 where id_generales_empresa = $2",
      [vision, id_generales_empresa]
    );
    if (response.error) {
      res.status(401).json(response.error);
    } else {
...
const updateObjetivo = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "update general_empresa set objetivos = $1 where id_generales_empresa = $2",
      [objetivos, id_generales_empresa]
    );
    if (response.error) {
      res.status(401).json(response.error);
    } else {
...
const updateValues = async (req, res) => {
  try {
    ...
    const response = await pool.query(
      "update general_empresa set valores = $1 where id_generales_empresa = $2",
      [valores, id_generales_empresa]
    );
    if (response.error) {
      res.status(401).json(response.error);
    } else {
...
const selectLogoImg = async (req, res) => {
  const response = await pool.query(
    "select logo from general_empresa where id_generales_empresa = 1"
  );
