  ...
  async (req, res) => {
    try {
      ...
      const response = await pool.query(
        "insert into educacion (id_educacion, titulo, adjunto) values ($1,$2,$3)",
        [id_educacion, titulo, adjunto]
      );
      ...
      if (response.error) {
        ...
        const response = await pool.query(
          "insert into educacion_usuarios (documento_usuarios_titulo,id_titulo) values ($1,$2)",
          [documento_usuarios_titulo, id_titulo]
        );
